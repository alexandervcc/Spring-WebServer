...
public class EmployeeAPIController {
	...
	public Employee postCreateEmployee(@RequestBody Employee emp) {
	...
	public Employee putUpdateEmployee(@RequestBody Employee emp) {
	...
	public Employee patchPartialUpdate(@PathVariable Long id, @RequestBody Employee patchEmp) {
